...
/* Статистика повітряних тривог у регіоні (довідково, зовнішнє посилання).
   На alerts.in.ua: внизу іконка пісочного годинника ⌛ («Тривалості») → праворуч «За останні 7 днів»
   → знайти свою область → кількість і сумарна тривалість тривог. Відкриваємо мапу в новій вкладці. */
