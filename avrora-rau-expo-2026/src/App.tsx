...
productsByLanguage.ua[0] = {
  ...
  bullets: [
    ...
    "Знизити неефективні витрати на аутсорс: 240 люд./год (30 тис. грн) на місяць і 2880 люд./год (360 тис. грн) на рік.",
    "Можливість бачити реальну загальну картину трафіку і конверсії та заглибитись у кожен регіон, магазин і годину роботи.",
    "Це інструмент для оцінки ефективності як окремого магазину, так і типу магазинів у порівнянні один до одного, з аналізом динаміки.",
