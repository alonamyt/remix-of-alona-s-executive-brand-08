...
productsByLanguage.ua[0] = {
  ...
  bullets: [
    ...
    "Знизити неефективні витрати на аутсорс: 12 тис. люд./год (1,5 млн/міс) і 18 млн на рік. Також години буденної роботи аналітика зі зведення даних замінити на ціннісне використання ресурсу на прийняття рішень з покращень.",
